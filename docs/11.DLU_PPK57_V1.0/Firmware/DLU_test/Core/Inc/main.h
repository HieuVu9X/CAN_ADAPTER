...
#define USART3_DIR_Pin GPIO_PIN_10
#define USART3_DIR_GPIO_Port GPIOD
#define USART6_DIR_Pin GPIO_PIN_8
#define USART6_DIR_GPIO_Port GPIOC
...
#define DB_LED_Pin GPIO_PIN_8
#define DB_LED_GPIO_Port GPIOB
